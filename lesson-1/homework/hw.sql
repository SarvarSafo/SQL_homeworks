...
/* 7. Research and explain the different SQL commands: DQL, DML, DDL, DCL, TCL with examples.
   Answer:
  DQL	Read data	SELECT	Look at a notebook
  DML	Change data	INSERT, UPDATE, DELETE	Edit notes
  DDL	Structure	CREATE, ALTER, DROP	Build or remove tables
  DCL	Permissions	GRANT, REVOKE	Give/take permission
  TCL	Transactions	COMMIT, ROLLBACK	Save or cancel changes
*/
...
TO DISK = 'C:\SQL_Backups\SchoolDB_backup.bak';

  -- RESTORE DATABASE SchoolDB
FROM DISK = 'C:\SQL_Backups\SchoolDB_backup.bak'
WITH REPLACE;
