...
select Orders.OrderID, CONCAT_WS(' ', Customers.FirstName, Customers.LastName) as Customername
...
select CONCAT_WS(' ', Customers.FirstName, Customers.LastName) as Customername, Orders.OrderID, Orders.OrderDate
from Customers
join Orders on
...
SELECT  CONCAT_WS(' ', Customers.FirstName, Customers.LastName) AS CustomerName,
...
select CONCAT_WS(' ', Customers.FirstName, Customers.LastName) as CustomerName,
Orders.OrderID, Orders.TotalAmount as OrderTotal
from Orders
...
'HR' AS DepartmentName, 
Employees.Salary
FROM Employees
JOIN Departments ON Employees.DepartmentID = Departments.DepartmentID
WHERE Departments.DepartmentName = 'Human Resources' AND Employees.Salary > 50000;
...
select Employees.Name as EmployeeName, Departments.DepartmentName, Employees.HireDate from Employees
join Departments on Employees.DepartmentID = Departments.DepartmentID
...
select CONCAT_WS(' ', Customers.FirstName, Customers.LastName) as CustomerName, 
Orders.OrderID, Customers.Address, Orders.OrderDate from Customers
...
join Sales on Products.ProductID = Sales.ProductID
where Products.Category = 1 or Sales.SaleAmount > 350 /* "Category 1 represents the 'Electronics' category in our data."*/
...
select Employees.Name as EmplployeeName, Departments.DepartmentName
from Employees
join Departments on
Employees.DepartmentID = Departments.DepartmentID
where(Departments.DepartmentName = 'HR' or Departments.DepartmentName = 'Finance')
or Employees.Name like '%aeiou%'

--Return: ProductName, QuantitySold, Price
--Task: List products that had a sales quantity above 100 and a price above 500.
--Tables Used: Sales, Products

select Products.ProductName, Sales.SaleAmount
as QuantitySold, Products.Price
from Sales
join Products on Sales.ProductID = Products.ProductID
where Sales.SaleAmount > 100 and Products.Price > 500  /* We don't have Quantity column, therefore we use SaleAmount*/

--Return: EmployeeName, DepartmentName, Salary
--Task: Show employees who are in the Sales or Marketing department and have a salary above 60000.
--Tables Used: Employees, Departments

select Employees.Name as EmployeeName, Departments.DepartmentName, Employees.Salary
from Employees
join Departments on Employees.DepartmentID = Departments.DepartmentID
