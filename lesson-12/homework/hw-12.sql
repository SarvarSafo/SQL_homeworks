...
select Cart1.Item as [Item card 1], Cart2.Item as [Item card 2] from Cart1
...
select c.name customername from Customers c
...
select
	...
	S.student_name, 
	Sb.subject_name,
	count(E.subject_name) as attendent_exams
from Students S
