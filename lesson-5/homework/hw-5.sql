...
select productid, productname, price, category, stockquantity, iif (price > 1000, 'Expensive', 'Affordable')
as Pricerange from Products
...
/*16.Write a query that uses a CASE statement to determine the discount percentage based on the quantity purchased. 
